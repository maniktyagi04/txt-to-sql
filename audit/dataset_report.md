# Beaver Academic Dataset Report

This report documents the schema, relations, and sample records of the **Beaver academic dataset** used in the Text-to-SQL challenge. 
